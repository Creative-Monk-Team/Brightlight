...
let OpenWorkPermitFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/openWorkPerFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/openWorkPerFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default OpenWorkPermitFaq;
