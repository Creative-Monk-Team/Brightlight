...
let StemTargetedDrawFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/stemTargetedDrawFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/stemTargetedDrawFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default StemTargetedDrawFaq;
