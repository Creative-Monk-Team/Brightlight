...
let PrioritiesProgramFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/prioritiesProgramFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/prioritiesProgramFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default PrioritiesProgramFaq;
