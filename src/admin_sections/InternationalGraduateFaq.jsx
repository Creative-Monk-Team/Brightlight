...
import InternationalGraduateMeta from "./InternationalGraduateMeta";
let InternationalGraduateFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/internationalGraduateProgFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/internationalGraduateProgFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default InternationalGraduateFaq;
