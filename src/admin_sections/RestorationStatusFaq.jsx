...
let RestorationFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/restorationStatusDraftFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/restorationStatusDraftFaq")
      .then((res) => res.json())
      .then((data) => {
