...
let TransportOccupationTarFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/transportOccuptionTargDrawFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/transportOccuptionTargDrawFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default TransportOccupationTarFaq;
