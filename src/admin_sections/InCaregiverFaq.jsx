...
let InCaregiverFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/inHomeCaregiverProgramLpFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/inHomeCaregiverProgramLpFaq")
      .then((res) => res.json())
      .then((data) => {
