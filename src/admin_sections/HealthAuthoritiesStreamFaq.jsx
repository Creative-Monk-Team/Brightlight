...
let HealthAuthoritiesStreamFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/healthAuthorityStreamFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/healthAuthorityStreamFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default HealthAuthoritiesStreamFaq;
