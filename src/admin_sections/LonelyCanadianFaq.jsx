...
let LonelyCanadianFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/lonelyCanadianFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/lonelyCanadianFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default LonelyCanadianFaq;
