...
const CommonLawParenerInternationalFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/comLawPartnerInternFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/comLawPartnerInternFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default CommonLawParenerInternationalFaq;
