...
let InsideCanadaFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/insideCanadaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/insideCanadaFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default InsideCanadaFaq;
