...
import OpenWorkCanadaMeta from "./OpenWorkCanadaMeta";
import PathwaysForCaregiverMeta from "./PathwaysForCaregiverMeta";
let PathwaysForCaregiverFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/pathwaysForCaregiverFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/pathwaysForCaregiverFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default PathwaysForCaregiverFaq;
