...
let StudyPermitMinorsFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/studyPermitMinorsFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/studyPermitMinorsFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default StudyPermitMinorsFaq;
