...
let SpousalOpenWorkPermitFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/spousalOpenWokPerFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/spousalOpenWokPerFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default SpousalOpenWorkPermitFaq;
