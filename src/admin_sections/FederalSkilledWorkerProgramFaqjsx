...
let FederalSkilledWorkerProgramFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/federalSkillWorkerProgFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/federalSkillWorkerProgFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default FederalSkilledWorkerProgramFaq;
