...
let OpenWorkVulnerableFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/openWorkVulnerableFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/openWorkVulnerableFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default OpenWorkVulnerableFaq;
