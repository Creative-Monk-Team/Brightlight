...
let ReconsiderationFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/reconsiderationFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/reconsiderationFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default ReconsiderationFaq;
