...
let VisitorToStudentFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/visitorToStudentFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/visitorToStudentFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default VisitorToStudentFaq;
