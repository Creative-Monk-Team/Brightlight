...
let OpenWorkCanadaFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/OpenWorkCanadaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/OpenWorkCanadaFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default OpenWorkCanadaFaq;
