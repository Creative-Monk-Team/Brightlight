...
let TemporaryResidencyFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/temporaryResidencyFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/temporaryResidencyFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default TemporaryResidencyFaq;
