...
let CommonLawPartnerTemporaryFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/comLawPartTempFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/comLawPartTempFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default CommonLawPartnerTemporaryFaq;
