...
let DualIntentVisaFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/dualintentVisaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/dualintentVisaFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default DualIntentVisaFaq;
