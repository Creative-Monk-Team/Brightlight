...
let OutsideCanadaFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/outsideCanadaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/outsideCanadaFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default OutsideCanadaFaq;
