...
import HumanContent from "./HumanitarianCompassionateMeta";
let HumanFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/humanitarianComFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/humanitarianComFaq")
      .then((res) => res.json())
      .then((data) => {
