...
let InternationalPostGraduateFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/internationalPostGraduateProgFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/internationalPostGraduateProgFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default InternationalPostGraduateFaq;
