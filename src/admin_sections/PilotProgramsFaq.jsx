...
let PilotProgramFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/pilotProgramFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/pilotProgramFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default PilotProgramFaq;
