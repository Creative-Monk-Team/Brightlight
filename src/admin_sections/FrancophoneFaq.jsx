...
let FrancophoneFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/francophoneMobilityFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/francophoneMobilityFaq")
      .then((res) => res.json())
      .then((data) => {
