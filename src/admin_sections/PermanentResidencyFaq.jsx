...
let PermanentResidencyFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/permanent-faq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/permanent-faq")
      .then((res) => res.json())
      .then((data) => {
...
export default PermanentResidencyFaq;
