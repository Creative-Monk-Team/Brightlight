...
let SpouseInlandFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/spousalInlandFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/spousalInlandFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default SpouseInlandFaq;
