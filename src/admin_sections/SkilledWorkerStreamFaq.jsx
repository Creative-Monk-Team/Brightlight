...
import SkilledWorkerStreamMeta from "./SkilledWorkerStreamMeta";
let SkilledWorkerStreamFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/skilledWorkerStreamFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/skilledWorkerStreamFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default SkilledWorkerStreamFaq;
