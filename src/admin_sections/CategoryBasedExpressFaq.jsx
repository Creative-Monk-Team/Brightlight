...
let CategoryBasedExpressFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/categoryBasedExpressFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/categoryBasedExpressFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default CategoryBasedExpressFaq;
