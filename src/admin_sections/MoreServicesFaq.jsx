...
let MoreServicesFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/moreServicesFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/moreServicesFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default MoreServicesFaq;
