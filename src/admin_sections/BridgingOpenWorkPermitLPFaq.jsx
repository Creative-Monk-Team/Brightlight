...
let BridgingOpenWorkPermitLPFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/bridgingOpenWorkFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/bridgingOpenWorkFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default BridgingOpenWorkPermitLPFaq;
