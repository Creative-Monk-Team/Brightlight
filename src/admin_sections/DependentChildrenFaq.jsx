...
let DependentChildrenFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/dependentChildFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/dependentChildFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default DependentChildrenFaq;
