...
let ExtensionsDraftFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/ExtensionsDraftFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/ExtensionsDraftFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default ExtensionsDraftFaq;
