...
let HealthcareTargetedDrawFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/healthcareTargatedDrawFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/healthcareTargatedDrawFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default HealthcareTargetedDrawFaq;
