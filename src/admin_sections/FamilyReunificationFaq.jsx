...
let FamilyReunificationFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/familyReunificationFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/familyReunificationFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default FamilyReunificationFaq;
