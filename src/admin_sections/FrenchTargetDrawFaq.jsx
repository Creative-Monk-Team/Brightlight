...
let FrenchTargetedDrawFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/frenchTargetedDrawFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/frenchTargetedDrawFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default FrenchTargetedDrawFaq;
