...
let CommonLawPartnerPermanentFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/comLawPartPermanFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/comLawPartPermanFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default CommonLawPartnerPermanentFaq;
