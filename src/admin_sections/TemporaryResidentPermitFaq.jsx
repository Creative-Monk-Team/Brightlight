...
let TemporaryResidencyPermitFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/temporaryResidentPermFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/temporaryResidentPermFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default TemporaryResidencyPermitFaq;
