...
let ChangeCollegeProgramFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/changeCollegeProgFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/changeCollegeProgFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default ChangeCollegeProgramFaq;
