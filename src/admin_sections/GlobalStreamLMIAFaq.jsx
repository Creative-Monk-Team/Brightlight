...
let GlobalStreamLMIAFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/globalStreamLmiaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/globalStreamLmiaFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default GlobalStreamLMIAFaq;
