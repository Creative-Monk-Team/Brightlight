...
let BusinessVisitorVisaFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/buisinessVisitorVisaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/buisinessVisitorVisaFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default BusinessVisitorVisaFaq;
