...
let LowWageLMIAFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/lowWageLmiaFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/lowWageLmiaFaq")
      .then((res) => res.json())
      .then((data) => {
