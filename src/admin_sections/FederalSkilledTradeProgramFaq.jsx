...
let FederalSkilledTradeProgramFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/federalSkillTradesProgFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/federalSkillTradesProgFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default FederalSkilledTradeProgramFaq;
