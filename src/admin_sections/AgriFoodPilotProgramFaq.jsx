...
let AgriFoodPilotProgramFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/agriFoodPilotProgFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/agriFoodPilotProgFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default AgriFoodPilotProgramFaq;
