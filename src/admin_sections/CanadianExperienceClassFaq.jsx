...
let CanadianExperienceClassFaq = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/canadianExperienceClassFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/canadianExperienceClassFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default CanadianExperienceClassFaq;
