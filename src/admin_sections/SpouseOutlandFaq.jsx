...
let SpouseOutlandFaq = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/spousalOutlandFaq/${FaqData._id}`, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/spousalOutlandFaq")
      .then((res) => res.json())
      .then((data) => {
...
export default SpouseOutlandFaq;
