...
export async function getServerSideProps() {
  try {
    const res = await fetch("https://brightlight-node.onrender.com/adopMeta");
  ...
  return (
    <>
      ...
      <div className={styles.container} id="container">
        ...
        >
          <h3> {pData?.howApplySponsoringChildAdopHeading}</h3>
