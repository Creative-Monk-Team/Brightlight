...
export async function getServerSideProps() {
  return fetchSeoData("inHomeCaregiverProgramLpMeta"); // Pass the API endpoint specific to this page
}

const InCaregiverProgramLP = ({metaData}) => {
      ...
      <div className={styles.container} id="container">
        ...
        >
          ...
          >
            ...
            >
              <h2 className="text-3xl"> {pData?.foreign1}</h2>
              <p>
              {pData?.foreign1Desc}
              </p>
            </div>
            ...
            >
              <h2 className="text-3xl"> {pData?.foreign2}</h2>
              <p>
              {pData?.foreign2Desc}
              </p>
        ...
        >
          ...
          <h2 className="text-3xl">{pData?.asEmployer}</h2>
          ...
          <h2 className="text-3xl">{pData?.asForiegn}</h2>
          <ul
            style={{ marginTop: "20px", marginLeft: "40px" }}
            className={`${styles.section} ${styles.section}`}
            id="testing14"
