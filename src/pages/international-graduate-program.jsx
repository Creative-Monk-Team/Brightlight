...
export async function getServerSideProps() {
  return fetchSeoData("igp-meta"); // Pass the API endpoint specific to this page
}

const InternationalGraduateProgram = ({metaData}) => {
...
const handleScroll = () => {
  ...
  return (
    <>
      <Head>
      <link rel="canonical" href="https://brightlightimmigration.ca/international-graduate-program" />
        <title>
          {metaData?.metaTitle
            ? metaData?.metaTitle
