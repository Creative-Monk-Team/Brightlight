...
export async function getServerSideProps() {
  return fetchSeoData("lonelyCanadianMeta"); // Pass the API endpoint specific to this page
}

const LonelyCanadian = ({metaData}) => {
